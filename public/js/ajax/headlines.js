...
$.ajax({
	...
	success: function(data) {
		$('.hbt').html(data[0]['judul']);
		$('.headline-image-b > img').attr('src', path+'/'+data[0]['gambar']);
		$('.aa-1').hide();
		$('.a-1').attr( "style", "display: block !important;" );
...
$.ajax({
	...
	success: function(data) {
		...
		$('.aa-2').hide();
		$('.a-2').attr( "style", "display: block !important;" );
...
$.ajax({
	...
	success: function(data) {
		...
		$('.aa-3').hide();
		$('.a-3').attr( "style", "display: block !important;" );
...
$.ajax({
	...
	success: function(data) {
		...
		$('.aa-4').hide();
		$('.a-4').attr( "style", "display: block !important;" );
...
$.ajax({
	...
	success: function(data) {
		...
		$('.aa-5').hide();
		$('.a-5').attr( "style", "display: block !important;" );
